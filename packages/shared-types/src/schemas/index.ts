...
const EnvironmentZ = z.object({
    name: z.string().min(1),
    cdf_project: z.string().optional(),
    cdf_cluster: z.string().min(1),
    cdf_region: z.string().optional(),
...
export const Tier00SolutionDesignZ = z.object({
    ...
    cdf_cluster: z.string().optional(),
    governanceBaseline: z.enum(['default', 'custom']).optional(),
    ...
    globalStandards: z
        .object({
            timestampStandard: z.enum(['ISO_8601_UTC', 'RFC_3339', 'UNIX_EPOCH_MS', 'UNIX_EPOCH_S']).optional(),
            prefixExternalIdsWithModuleId: z.boolean().optional(),
            naming: z
                .object({
                    caseStyle: z.enum(['snake', 'kebab', 'pascal']).optional(),
                    idSeparator: z.enum(['_', '-']).optional(),
                    nameSeparator: z.enum([':', '-', '_', '/']).optional(),
                    prefixes: z
                        .object({
                            extractionPipeline: z.string().optional(),
    ...
    variables: z
        .object({
            ...
            schemaSpaces: z
                ...
                .optional(),
            instanceSpaces: z.array(z.string()).optional(),
            dataSets: z
                .array(
                    z.object({
                        name: z.string(),
...
// Phase 2/3 — New schemas
export { ModelOverviewZ, type ModelOverview } from './phase2_model_overview.js';
export { EntitySpecsZ, type EntitySpecs } from './phase3_entity_specs.js';
export { ModelDesignZ, type ModelDesign } from './unified_model_design.js';
