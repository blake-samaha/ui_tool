...
function main() {
  const appDist = path.resolve(__dirname, '../packages/ui-application/dist');
  ensure(appDist, 'ui-application build dist exists');
  ensure(path.join(appDist, 'index.html'), 'ui-application index.html exists');
